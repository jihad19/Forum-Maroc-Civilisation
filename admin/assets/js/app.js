...
App = function() {
    ...
    return App.ajaxLoader = function() {
        ...
        $(".toggle-loader").click(function(a) {
            a.preventDefault();
            ...
            request.addEventListener('readystatechange', function() {
                if(request.readyState == 2 && request.status == 200) {
                    ...
                    // Set href as a local object URL, Set name of download
                    clicked.attr({
                        "href" : _OBJECT_URL,
                        "download" : name
                    });
                    
                    $(" <a id='click_ajax' href='"+_OBJECT_URL+"' download='"+name+"'>click_ajax</a>")[0].click();
    ...
    return App.dashboard = function() {
        ...
        $('[data-toggle="counter"]').each(function(e, t) {
            ...
            i = App.color.success, 
            o = App.color.danger, 
            $("#spark1").sparkline($("#spark1").data("sparkline").split(", "), {
            width: "150",
            height: "35",
            lineColor: e,
            highlightSpotColor: e,
            ...
            maxSpotColor: !1,
            lineWidth: 1.15
        }), $("#spark2").sparkline($("#spark2").data("sparkline").split(", "), {
            type: "bar",
            width: "150",
            height: "35",
            barWidth: 5,
            ...
            chartRangeMin: 0,
            barColor: t
        }), $("#spark3").sparkline($("#spark3").data("sparkline").split(", "), {
            type: "discrete",
            width: "150",
            height: "35",
            lineHeight: 20,
            lineColor: i,
            xwidth: 18
        }), $("#spark4").sparkline($("#spark4").data("sparkline").split(", "), {
            width: "150",
            height: "35",
            lineColor: o,
            highlightSpotColor: o,
