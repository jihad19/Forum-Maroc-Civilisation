            ...
            <div class="left-sidebar-scroll ps ps--active-y">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li <?php if($page=='home') echo 'class="active"';?> ><a href="<?="$originPath/"?>"><i class="icon mdi mdi-home"></i><span>Dashboard</span></a></li>
                  <li <?php if($page=='student') echo 'class="active"';?> ><a href="<?="$originPath/student/showAll.php"?>"><i class="icon mdi mdi-face"></i><span>Students</span></a></li>
                  <li <?php if($page=='woman') echo 'class="active"';?> ><a href="<?="$originPath/woman/showAll.php"?>"><i class="icon mdi mdi-accounts-alt"></i><span>Women</span></a></li>
                  <li <?php if($page=='post') echo 'class="active"';?> ><a href="<?="$originPath/post/showAll.php"?>"><i class="icon mdi mdi-book"></i><span>Post</span></a></li>
                  <li class="d-none parent"><a href="#"><i class="icon mdi mdi-face"></i><span>UI Elements</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="d-none parent"><a href="charts.html"><i class="icon mdi mdi-chart-donut"></i><span>Charts</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="d-none parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Forms</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="d-none parent"><a href="#"><i class="icon mdi mdi-border-all"></i><span>Tables</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="d-none parent"><a href="#"><i class="icon mdi mdi-layers"></i><span>Pages</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="d-none divider">Features</li>
                  <li class="d-none parent"><a href="#"><i class="icon mdi mdi-inbox"></i><span>Email</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="d-none parent"><a href="#"><i class="icon mdi mdi-view-web"></i><span>Layouts</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="d-none parent"><a href="#"><i class="icon mdi mdi-pin"></i><span>Maps</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="d-none parent"><a href="#"><i class="icon mdi mdi-folder"></i><span>Menu Levels</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="d-none "><a href="documentation.html"><i class="icon mdi mdi-book"></i><span>Documentation</span></a>
                  </li>
                </ul>
              </div>
            <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; right: 0px; height: 220px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 92px;"></div></div></div>
          </div>
          <div class="d-none progress-widget">
